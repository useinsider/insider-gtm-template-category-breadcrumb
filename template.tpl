...

{
  ...
  "description": "This template gets the categories on category page. Variable\u0027 value type should be array",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "categories",
    "displayName": "Categories Variable",
    "simpleValueType": true,
    "defaultValue": "listing.taxonomy"
  }
]
...
insiderObject.listing = {
    taxonomy: getData(data.categories) || ''
};
...
Created on 11/20/2020, 3:01:44 PM
